...
import com.oopsjpeg.osu4j.backend.EndpointUserBests.Arguments;
import com.oopsjpeg.osu4j.backend.Osu.APIAccess;
import com.oopsjpeg.osu4j.exception.OsuAPIException;

import java.util.*;

public class EndpointUserBests implements Endpoint<Arguments, List<OsuScore>> {
	private static final String API_ENDPOINT = "/api/get_user_best";
	private final APIAccess api;

	public EndpointUserBests(APIAccess api) {
		this.api = api;
	}
